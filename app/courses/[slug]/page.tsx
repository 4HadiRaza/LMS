...
import { getCourseBySlug, getInstructorById, reviews, getTotalLessons } from '@/lib/mockData';
...
export default function CourseDetailPage() {
  ...
  const handleEnroll = () => {
    ...
    else router.push(`/checkout/${course.slug}`);
  };
              ...
              <div className="space-y-8 animate-fade-in">
                ...
                <div>
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                    {['Understand core concepts and frameworks', 'Apply knowledge to real-world scenarios',
                      'Prepare for professional certifications', 'Master FBR compliance requirements',
                      'Build confidence in audit preparation', 'Navigate complex tax regulations'].map((item, i) => (
                ...
                <div>
                  ...
                  <ul className="space-y-2">
                    {['Basic understanding of accounting principles', 'Access to a computer with internet',
                      'Willingness to learn and practice'].map((r, i) => (
